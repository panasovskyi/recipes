...
export const RecipesPage: React.FC = () => {
  ...
  const { category, subCategory, sort, search, ingredients, maxTime, maxCalories, ...filterActions } =
    useRecipesFilters();

  useEffect(() => {
    dispatch(fetchRecipes({ category, subCategory, sort, search, maxTime, maxCalories, ingredients }));
  }, [dispatch, category, subCategory, sort, search, ingredients, maxTime, maxCalories]);
